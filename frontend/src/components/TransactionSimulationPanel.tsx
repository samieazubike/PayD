        ...
        return (
            <div className={styles.container}>
                ...
                <div className={`${styles.statusBox} ${styles.statusError}`}>
                    <div className={styles.statusIcon}><WarningIcon /></div>
                    <div className={styles.statusContent}>
                        <h4 className={styles.statusTitle}>Simulation unavailable</h4>
                        <p className={styles.statusDesc}>{processError}</p>
                    </div>
                </div>
                {onReset && <button onClick={onReset} className={styles.resetBtn}>Clear Results</button>}
            </div>
        );
    }
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <span className={styles.timestamp}>
                    {result.simulatedAt.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                </span>
            </div>
